...
const val EXTRA_FRAGMENT = "me.jfenn.alarmio.MainActivity.EXTRA_FRAGMENT"
...
@SuppressLint("NewApi")
fun Context.getPropertabcolor()= resources.getColor(R.color.text_color, theme)


fun Context.updateBottomTabItemColor(view: View?, isActive: Boolean) {
...
@SuppressLint("NewApi")
fun Context.getProperTextColo()=resources.getColor(R.color.tab_text_color, theme)
