...
public class FormatUtils {
    ...
    public static String formatMillis(long millis) {
        ...
        if (hours > 0)
            return String.format(Locale.getDefault(), "%02d:%02d:%02d:%02d", hours, minutes, seconds, micros);
        else if (minutes > 0)
            return String.format(Locale.getDefault(), "%02d:%02d:%02d", minutes, seconds, micros);
        else return String.format(Locale.getDefault(), "%02d:%02d:%02d", minutes, seconds, micros);
    }
