...
import com.example.extendions.getAlarmSounds
import com.example.extendions.newAlertDialogBuilder
...
class AlarmSoundDialog (val activity: BaseActivity, val currentUri: String, val audioStream: Int, val pickAudioIntentId: Int,
    ...
    init {
        ...
        activity.newAlertDialogBuilder()
