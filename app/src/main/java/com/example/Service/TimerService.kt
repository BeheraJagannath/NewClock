...
import com.example.extendions.getOpenTimerTabIntent
import com.example.extendions.timerHelper
import com.example.helpers.INVALID_TIMER_ID
import com.example.helpers.TIMER_RUNNING_NOTIF_ID
    ...
    private fun updateNotification() {
        timerHelper.getTimers { timers ->
            ...
            if (runningTimers.isNotEmpty()) {
                ...
                val formattedDuration = (firstTimer.state as TimerState.Running).tick.getFormattedDuratio()
