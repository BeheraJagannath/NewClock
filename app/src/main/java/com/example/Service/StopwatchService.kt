...
import com.example.extendions.getFormattedDuratio
import com.example.extendions.getOpenStopwatchTabIntent
import com.example.helpers.STOPWATCH_RUNNING_NOTIF_ID
...
class StopwatchService : Service() {
    ...
    private fun updateNotification(totalTime: Long) {
        val formattedDuration = totalTime.getFormattedDuratio()
    ...
    private val updateListener = object : Stopwatch.UpdateListener {
        ...
        override fun onStateChanged(state: Stopwatch.State) {
            if (state == Stopwatch.State.STOPPED && isNougatPlus()) {
