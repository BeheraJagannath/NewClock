...
import com.example.Activities.SnoozeReminderActivity
import com.example.Activities.SplashActivity
import com.example.Database.AppDatabase
import com.example.Service.SnoozeService
import com.example.helpers.*
import com.example.interfaces.TimerDao
import com.example.models.Alarm
import com.example.models.MyTimeZone
...
import com.example.receivers.HideAlarmReceiver
import com.example.receivers.HideTimerReceiver
...
fun Context.getAlarmSelectedDaysString(bitMask: Int): String {
    return when (bitMask) {
        ...
        else -> getSelectedDaysStrin(bitMask)
    }
}

fun Context.getSelectedDaysStrin(bitMask: Int): String {
...
fun Context.getAlarmNotification(pendingIntent: PendingIntent, alarm: Alarm): Notification {
    ...
    val builder = NotificationCompat.Builder(this)
        ...
        .addAction(R.drawable.snooze_vector, getString(R.string.snooze), getSnoozePendingIntent(alarm))
        .addAction(R.drawable.ic_clock_vector, getString(R.string.dismiss), dismissIntent)
...
fun Context.getNextAlarm(): String {
    ...
    val dayOfWeek = resources.getStringArray(R.array.next_alarm)[dayOfWeekIndex]
...
fun Activity.newAlertDialogBuilder() = if (baseConfig.isUsingSystemTheme) {
    MaterialAlertDialogBuilder(this)
} else {
    AlertDialog.Builder(this,R.style.alert_dialog_custom)
}
