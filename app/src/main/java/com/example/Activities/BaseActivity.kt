...
//        updateRecentsAppIcon()
    ...
    fun setupToolbar(
        ...
        toolbar.overflowIcon = resources.getColoredDrawableWithColor(com.simplemobiletools.commons.R.drawable.ic_three_dots_vector, contrastColor)

        if (toolbarNavigationIcon != NavigationIcon.None) {
            val drawableId = if (toolbarNavigationIcon == NavigationIcon.Cross) R.drawable.ic_close_vector else com.simplemobiletools.commons.R.drawable.ic_arrow_left_vector
        ...
        toolbar.collapseIcon = resources.getColoredDrawableWithColor(com.simplemobiletools.commons.R.drawable.ic_arrow_left_vector, contrastColor)
...
//            putExtra(APP_LAUNCHER_NAME, getAppLauncherName())
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.example.newclock")) {
            callback(true)
            false
...
//            toast(text, Toast.LENGTH_LONG)
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.example.newclock")
