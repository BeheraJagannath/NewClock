...
abstract class MyRecyclerAdapter(val activity: BaseActivity, val recyclerView: RecyclerView, val itemClick: (Any) -> Unit) :
...
//    }
    ...
    protected fun removesingle(positions: Int) {
